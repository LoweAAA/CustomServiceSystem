package com.givemefive.customerservicesystem.model.VO;
...
public class VOConstant {
    ...
    public final static String LOGINCONFIRM_PASS = "Login pass!";//登录成功

    public final static String LOGINCONFIRM_FAILD = "账号或密码错误！";
