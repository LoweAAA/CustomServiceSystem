...
public class MD5Util {
    ...
    private static String MD5Encode(String origin, String charsetname) {
        ...
        try {
            ...
            logger.error(resultString,exception);
        }
     ...
     */
    public static String MD5EncodeUtf8PWD(String origin) {
//        加盐操作，防止通过MD5字典进行解密
     ...
     * @return
     */
    public static String MD5EncodeUtf8Token(String origin) {
//        加盐操作，防止通过MD5字典进行解密
        origin = "520" + origin + "521";
        return MD5Encode(origin, "utf-8");
    }
